...
!
!call get_shared_node(element_data,element_nums,node_nums, & !LUCIANO
        ! shared_node_local,shared_node,shared_node_size, &  !LUCIANO
        ! send_nums,num_local, epart,npart, numprocs,myid)   !LUCIANO
!print*, 'get_shared_node finished' !LUCIANO

! call get_local_element_id(epart, element_nums, numprocs,&
          ! local_elements,local_nums) !!LUCIANO
